...
public class OHStyle {
    ...
    public static final String CLASS_COMBO_BOX = ".combo-box";
    public static final String CLASS_TEXT_BUTTON = ".text_button";
    public static final String CLASS_SCROLL_BAR = ".scroll-bar";
